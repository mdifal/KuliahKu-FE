...
class CalenderTaskCollabPlan extends StatefulWidget {
  final String? groupId;
  const CalenderTaskCollabPlan({Key? key,this.groupId})
      : super(key: key);

  @override
  State<CalenderTaskCollabPlan> createState() => _CalenderTaskCollabPlanState();
}

class _CalenderTaskCollabPlanState extends State<CalenderTaskCollabPlan> {
...
void initState() {
  ...
  var url = 'http://$ipUrl/groups/${widget.groupId}/plans/subgroup/$IdSubgroup';
