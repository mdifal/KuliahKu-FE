...
class CardHistory extends StatelessWidget {
  ...
  const CardHistory(
      {Key? key, this.title, this.type, this.mataKuliah, this.time, this.color})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    String formattedTime = formatDuration(
        time ?? 0); // Mengonversi waktu dalam detik ke format yang diinginkan
          ...
          Row(
            children: [
              Padding(
                ...
                child: Icon(Icons.access_time_outlined, size: 20, color: white),
              ),
              Text(
                formattedTime,
                style: TextStyle(fontSize: 15, color: white),
